...
export const TRANSLATIONS = Object.freeze({
  fr: {
    ...
    "action.maximize": "Agrandir l'aperçu",
    "action.restore": "Réduire l'aperçu",
  ...
  ar: {
    ...
    "action.paste": "لصق",
    "action.clear": "مسح",
    "action.maximize": "تكبير المعاينة",
    "action.restore": "تصغير المعاينة",
  ...
  en: {
    ...
    "action.paste": "Paste",
    "action.clear": "Clear",
    "action.maximize": "Maximize preview",
    "action.restore": "Restore preview",
